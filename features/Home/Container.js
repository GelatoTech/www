    ...
    <section className="hero" id="hero">
      <div id="hero-body">
        <div className="container has-text-centered">
          ...
          <a className="button is-info is-large" href="#repair">Book iPhone Repair<i className="fa fa-mobile" style={{ marginLeft: '1vh' }}></i></a>
        </div>
          ...
          <div className="columns owl-carousel owl-theme" style={{ marginLeft: 'auto', marginRight: 'auto', marginTop: '80px' }}>
            <div className="column">
              <div className="notification">
                ...
                <a className="button is-dangers is-rounded" href="https://www.yelp.com/biz/gelatotech-on-demand-iphone-repair-san-francisco-3?uid=LGLdTFOmQQoTMF7LOnMKmg&utm_campaign=www_business_share_popup&utm_medium=copy_link&utm_source=(direct)" target="_blank">Read on Yelp <i className="fa fa-yelp" style={{ marginLeft: '4px' }}></i></a>
              </div>
            </div>
            <div className="column">
              <div className="notification">
