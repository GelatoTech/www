        ...
        <div className="columns">
          <div className="column">
            <figure className="image">
              <img alt="Book your Samsung repair" src="images/undraw-calendar-dutt.png" style={{width: '40%', marginLeft: 'auto', marginRight: 'auto'}} />
          ...
          <div className="column">
            <figure className="image">
              ...
              <p className="subtitle is-5" data-aos="zoom-out" style={{margin: 'auto', textAlign: 'center'}}>We Repair your Samsung On-Spot, usually inside our car or your preferred location.</p>
            </figure>
          </div>
          <div className="column">
            <figure className="image">
              <img alt="Samsung screen repair on-spot" src="images/undraw-Credit-card-3ed6.png" style={{width: '40%', marginRight: 'auto', marginLeft: 'auto'}} />
              ...
              <div className="why-container" style={{ textAlign: 'left' }}>
                <ul style={{listStyle: 'none'}}>
                  ...
                  <li>
                    ...
                    <p className="subtitle is-5">You only pay after the repair is done and fully tested. Lifetime warranty is included on any Samsung Screen Repair.</p>
                  </li>
                  <li style={{listStyle: 'none'}}><br /></li>
                </ul>
              </div>
